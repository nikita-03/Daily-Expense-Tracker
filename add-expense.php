						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="">
								<div class="form-group">
									...
									<input class="form-control" type="date" value="" name="dateexpense" required="true" max="<?php echo date("Y-m-d"); ?>">
								</div>
								<div class="form-group">
									<label>Item</label>
								...
								<div class="form-group">
									...
									<input class="form-control" type="number" value="" required="true" min="1" name="costitem">
								</div>
